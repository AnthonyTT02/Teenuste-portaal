...
export default function SupportLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const result = await api('/api/support-login', {
        method: 'POST',
      ...
      <div className="relative z-10">
        ...
        <div className="animate-float" style={{ animationDuration: '8s' }}>
          <h2 className="text-[2.75rem] leading-none font-extrabold text-[#111827] mb-3 tracking-tight">
            Support <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand to-brand-light drop-shadow-sm">Panel</span>
          </h2>
        </div>
        <p className="text-gray-500 mb-10 text-[15px] font-medium tracking-wide">Support staff login</p>
