              ...
              <div>
                ...
                <div className="bg-white/70 border border-white/60 rounded-2xl p-5 mb-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button onClick={createService} className="px-5 py-2 bg-brand text-white font-bold rounded-xl text-sm hover:bg-brand-dark transition-colors">{t('add', 'Add')}</button>
                  </div>
                </div>
