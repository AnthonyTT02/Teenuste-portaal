      ...
      <div className="relative z-10">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-2">
            <button onClick={handleSignOut} className="px-4 py-2 rounded-xl bg-gray-50 hover:bg-red-50 text-gray-600 hover:text-red-500 font-bold text-[13px] transition-colors border border-gray-200/60">Sign Out</button>
            <button 
              type="button"
              onClick={openSidebar}
